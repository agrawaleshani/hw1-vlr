...
class VOCDataset(Dataset):
    ...
    def preload_anno(self):
        ...
        for index in self.index_list:
            ...
            for child in root.findall('object'):
                class_ind = self.get_class_index(child.find('name').text)
                class_vec[class_ind] = 1
                if child.find('difficult').text == '0':
                    weight_vec[class_ind] = 1
    ...
    def get_random_augmentations(self):
        ...
        if self.split == "train":
            return [transforms.CenterCrop(224),transforms.RandomHorizontalFlip(0.3), transforms.RandomRotation(20)]
        return []
